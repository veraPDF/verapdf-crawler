...
public class ResourceManager {
    ...
    public ResourceManager(HeritrixClient client, EmailServer emailServer, String verapdfPath, MySqlCredentials credentials) {
        ...
        validationService = new ValidationService(verapdfPath, client.getBaseDirectory(), this, credentials);
    ...
    public SingleURLJobReport getJob(String job) { return controlResource.getJob(job); }
