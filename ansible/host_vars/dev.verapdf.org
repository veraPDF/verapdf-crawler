...
ansible_ssh_host: 139.162.244.61
# Domain of host, used to derive custom sub-domains
hostdomain: dev.verapdf.org
...
logius_git_root: "{{ logius_app_home }}/src"

# Disable schema re-creation
#
logius_db_create_schema: false
